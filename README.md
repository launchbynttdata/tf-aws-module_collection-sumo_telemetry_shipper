# tf-aws-wrapper_module-sumo_telemetry_shipper
...
| <a name="module_cloudwatch_log_group_wrapper"></a> [cloudwatch\_log\_group\_wrapper](#module\_cloudwatch\_log\_group\_wrapper) | git::https://github.com/nexient-llc/tf-aws-wrapper_module-cloudwatch_logs | 0.1.0 |
| <a name="module_cloudwatch_metric_stream"></a> [cloudwatch\_metric\_stream](#module\_cloudwatch\_metric\_stream) | git::https://github.com/nexient-llc/tf-aws-module-cloudwatch_metric_stream.git | 0.1.0 |
| <a name="module_logs_firehose_delivery_stream"></a> [logs\_firehose\_delivery\_stream](#module\_logs\_firehose\_delivery\_stream) | git::https://github.com/nexient-llc/tf-aws-module-firehose_delivery_stream | 0.1.0 |
| <a name="module_metrics_firehose_delivery_stream"></a> [metrics\_firehose\_delivery\_stream](#module\_metrics\_firehose\_delivery\_stream) | git::https://github.com/nexient-llc/tf-aws-module-firehose_delivery_stream | 0.1.0 |
| <a name="module_logs_producer_role"></a> [logs\_producer\_role](#module\_logs\_producer\_role) | git::https://github.com/nexient-llc/tf-aws-wrapper_module-iam_assumable_role.git | 0.1.0 |
| <a name="module_logs_consumer_role"></a> [logs\_consumer\_role](#module\_logs\_consumer\_role) | git::https://github.com/nexient-llc/tf-aws-wrapper_module-iam_assumable_role.git | 0.1.0 |
| <a name="module_metrics_producer_role"></a> [metrics\_producer\_role](#module\_metrics\_producer\_role) | git::https://github.com/nexient-llc/tf-aws-wrapper_module-iam_assumable_role.git | 0.1.0 |
| <a name="module_metrics_consumer_role"></a> [metrics\_consumer\_role](#module\_metrics\_consumer\_role) | git::https://github.com/nexient-llc/tf-aws-wrapper_module-iam_assumable_role.git | 0.1.0 |
